...
- **Sprint:** 6 (Home Screen + Lock Screen Widgets) — **built, awaiting user verification on real simulator/emulator**
- **Next:** Sprint 7 (Polish & Accessibility) — Dynamic Type, VoiceOver/TalkBack labels, color-blind-safe check, cold-start/widget-tap perf profiling, empty/error/loading states, animation pass.
- **Locked this sprint:** tap-to-add from a widget deep-links into Quick Add (opens the app) rather than writing natively in-widget — see Sprint 6 section below for the full tradeoff.
